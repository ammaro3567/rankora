          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center">
              <div className="flex-shrink-0 flex items-center">
                ...
                <span className="ml-2 text-xl font-bold text-gray-900">Rankora</span>
              </div>
            </div>
          ...
          {isMenuOpen && (
            <div className="md:hidden border-t border-gray-200 py-4">
              <div className="flex flex-col space-y-2">
                ...
                <button
                  onClick={onSignup}
                  className="text-left bg-indigo-600 text-white px-3 py-2 rounded-lg text-sm font-medium hover:bg-indigo-700 transition duration-200 mx-3"
                >
                  Sign Up Free
                </button>
              </div>
        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className="max-w-3xl mx-auto">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-8 leading-tight">
              ...
              <span className="bg-gradient-to-r from-indigo-600 to-cyan-600 bg-clip-text text-transparent"> Ranked Success</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <button
                onClick={onSignup}
                className="w-full sm:w-auto bg-indigo-600 text-white px-8 py-4 rounded-xl text-lg font-semibold hover:bg-indigo-700 transform hover:scale-105 transition duration-200 shadow-lg"
              >
                Start Ranking Free
              </button>
              <button
                onClick={onLogin}
                className="w-full sm:w-auto border-2 border-gray-300 text-gray-700 px-8 py-4 rounded-xl text-lg font-semibold hover:border-gray-400 hover:bg-gray-50 transition duration-200"
              >
                Sign In
              </button>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 rounded-2xl p-8 hover:shadow-lg transition duration-300">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Smart Ranking</h3>
            ...
            <div className="bg-gray-50 rounded-2xl p-8 hover:shadow-lg transition duration-300">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-4">Custom Criteria</h3>
              <p className="text-gray-600">
      ...
      <section className="py-20 bg-gradient-to-r from-indigo-600 to-cyan-600">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <button
              onClick={onSignup}
              className="w-full sm:w-auto bg-white text-indigo-600 px-8 py-4 rounded-xl text-lg font-semibold hover:bg-gray-50 transform hover:scale-105 transition duration-200 shadow-lg"
            >
              Get Started Free
            </button>
            <button
              onClick={onPricing}
              className="w-full sm:w-auto border-2 border-white text-white px-8 py-4 rounded-xl text-lg font-semibold hover:bg-white hover:text-indigo-600 transition duration-200"
            >
              View Pricing
            </button>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><button onClick={onPricing} className="hover:text-white transition duration-200">Pricing</button></li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><button onClick={onLogin} className="hover:text-white transition duration-200">Login</button></li>
                <li><button onClick={onSignup} className="hover:text-white transition duration-200">Sign Up</button></li>
              </ul>
            </div>
          </div>
