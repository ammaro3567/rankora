            ...
            <div className="form-field">
              ...
              <div className="relative">
                <input
                  ...
                  className="input-primary pl-12 h-12 bg-white/95 text-gray-900 placeholder-gray-500 border border-gray-300 focus:border-emerald-400 focus:ring-emerald-400/20"
            ...
            <div className="form-field">
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleInputChange}
                  className="input-primary pl-12 pr-12 h-12 bg-white/95 text-gray-900 placeholder-gray-500 border border-gray-300 focus:border-emerald-400 focus:ring-emerald-400/20"
                  placeholder="••••••••••••"
