...
const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "Yes! API access is available with our Pro and Business plans. You can integrate Rankora's analysis capabilities directly into your content management system, editorial workflow, or custom applications."
  },
  {
  ...
  },
  {
    ...
    answer: "Yes! Pro and Business users can export detailed PDF reports of their analyses. These reports include all scores, recommendations, and are perfect for sharing with team members or clients."
  }
];
